...
try {
  ...
  const result = await sendPasswordResetEmail(testEmail, testToken, testUserType);
...
<parameter name="filePath">c:\Users\TUSHANKAR\Desktop\Domain\server\test-email-config.js